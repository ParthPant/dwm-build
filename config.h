...
static const char col_black[]       = "#211a1d";
static const char col_purple[]       = "#9126d4";
static const char col_green[]       = "#67cf97";
static const char col_cyan[]        = "#8075ff";
static const char col_blue[]        = "#6320ee";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_cyan,  col_cyan  },
	[SchemeStatus]  = { col_black, col_blue,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_black, col_purple,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm]  = { col_black, col_green,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { col_black, col_cyan,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
	[SchemeInfoNorm]  = { col_black, col_gray1,  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
};
